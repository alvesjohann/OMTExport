...
def AMOUNT_OF_OBJECTS(DISTANCE, GAP = 0.2, MIN = 2):
...
def OFFSET(DISTANCE, AMOUNT, GAP = 0.2):
...
def CREATE_ARRAY_OBJECTS(OBJECTS, LOCATION_XYZ, SCALE_XYZ, ROTATION_AXIS, ROTATION, AMOUNT, DISTANCE = 0.2, ARRAY_NAME = "Array"):
...
#MODIFICAR ESTAS FUNÇÕES PARA OPERADORES     
...
def APPEND_OBJECTS(OBJECT_POSITIONS, OBJECT_TO_APPEND, ACCESSORIES_PATH, DISTANCE = 0.2, SIDE = "SMALLER_LEFT"):
    
    SMALLER_SIDE_AXIS = OBJECT_POSITIONS["SMALLER_SIDE_AXIS"]
    SMALLER_SIDE_START = OBJECT_POSITIONS["SMALLER_SIDE_START"]
    #SMALLER_SIDE_END = OBJECT_POSITIONS["SMALLER_SIDE_END"]
    BIGGER_SIDE_AXIS = OBJECT_POSITIONS["BIGGER_SIDE_AXIS"]
    BIGGER_SIDE_START = OBJECT_POSITIONS["BIGGER_SIDE_START"]
    #BIGGER_SIDE_END = OBJECT_POSITIONS["BIGGER_SIDE_END"]
    THICKNESS_SIDE_AXIS = OBJECT_POSITIONS["THICKNESS_SIDE_AXIS"]
    THICKNESS_START = OBJECT_POSITIONS["THICKNESS_START"]
    #THICKNESS_END = OBJECT_POSITIONS["THICKNESS_END"]
    SMALLER_SIDE = OBJECT_POSITIONS["SMALLER_SIDE"]
    BIGGER_SIDE = OBJECT_POSITIONS["BIGGER_SIDE"]
    THICKNESS = OBJECT_POSITIONS["THICKNESS"]
    
    #ENCONTRAR QUANTIDADE DE OBJETOS
    SMALLER_SIDE_AMOUNT_OF_OBJECTS = AMOUNT_OF_OBJECTS(SMALLER_SIDE, DISTANCE)
    BIGGER_SIDE_AMOUNT_OF_OBJECTS = AMOUNT_OF_OBJECTS(BIGGER_SIDE, DISTANCE)
    
    #FATOR DE DESLOCAMENTO
    BIGGER_OFFSET = OFFSET(BIGGER_SIDE, BIGGER_SIDE_AMOUNT_OF_OBJECTS, DISTANCE)
    SMALLER_OFFSET = OFFSET(SMALLER_SIDE, SMALLER_SIDE_AMOUNT_OF_OBJECTS, DISTANCE)
    ...
    IMPORTED_OBJECTS = IMPORT_OBJECTS(PATH, OBJECT_TO_APPEND)
    ...
    CREATE_ARRAY_OBJECTS(IMPORTED_OBJECTS, LOCATION_XYZ, SCALE_XYZ, ROTATION_AXIS, ROTATION, AMOUNT, DISTANCE)