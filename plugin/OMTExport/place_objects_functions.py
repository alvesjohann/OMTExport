...
def AMOUNT_OF_OBJECTS(DISTANCE, MIN = 2, GAP = 0.2):
...
def CREATE_ARRAY_OBJECTS(OBJECTS, LOCATION_XYZ, SCALE_XYZ, ROTATION_AXIS, ROTATION, AMOUNT, ARRAY_NAME = "Array"):
    ...
    for OBJECT in OBJECTS:
        if OBJECT is not None:
            ...
            ADD_CONSTANT_ARRAY(OBJECT_TO_MOVE, AMOUNT, ARRAY_NAME)
...
def APPEND_OBJECTS(OBJECT_POSITIONS, SIDE = "SMALLER_LEFT"):
    ...
    CREATE_ARRAY_OBJECTS(IMPORTED_OBJECTS, LOCATION_XYZ, SCALE_XYZ, ROTATION_AXIS, ROTATION, AMOUNT)
